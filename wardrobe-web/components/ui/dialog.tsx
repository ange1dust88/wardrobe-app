...
export function DialogBackdrop({
  ...
  return (
    <DialogPrimitive.Backdrop
      className={cn(
        'fixed inset-0 z-50 bg-black/32 backdrop-blur-sm transition-all duration-300 data-ending-style:opacity-0 data-starting-style:opacity-0',
        className
      )}
