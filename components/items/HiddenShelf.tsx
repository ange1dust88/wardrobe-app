...
export function HiddenShelf({
  ...
  return (
    <>
      ...
      <div
        className='fixed top-[64px] right-[24px] z-50 flex max-h-[calc(100svh-96px)] w-[340px] max-w-[calc(100vw-40px)] flex-col overflow-hidden rounded-[16px] border border-border bg-card/95 shadow-[0_16px_44px_rgba(20,28,36,0.18)] backdrop-blur-md'
        style={{
          animation:
            state === 'in'
